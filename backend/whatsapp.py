...
WA_GATEWAY_URL = os.getenv("WA_GATEWAY_URL", "https://wagate.onrender.com")
...
def send_whatsapp_message(phone: str, message: str) -> dict:
    ...
    try:
        ...
        # Use the correct WAGate endpoint
        # The working endpoint from your test is: /api/chat/send with X-API-Key header
        response = requests.post(
            f"{WA_GATEWAY_URL}/api/chat/send",
            headers={
