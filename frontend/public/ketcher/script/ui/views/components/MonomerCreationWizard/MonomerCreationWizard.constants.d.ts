import type { MonomerTypeSelectItem, WizardNotificationMessageMap, WizardNotificationTypeMap } from './MonomerCreationWizard.types';
export declare const MonomerTypeSelectConfig: MonomerTypeSelectItem[];
export declare const MAX_MODIFICATION_TYPES = 5;
