...
declare function RGroup({ disabledIds, values, formState, type, ...props }: Props): import("react/jsx-runtime").JSX.Element;
declare const _default: import("react-redux").ConnectedComponent<typeof RGroup, {
    disabledIds: number[];
    values: number[];
    type: "atom" | "fragment";
    onCancel: () => void;
