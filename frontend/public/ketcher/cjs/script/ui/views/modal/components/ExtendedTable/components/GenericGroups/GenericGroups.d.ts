...
declare function GenericGroups({ selected, onAtomSelect, onAtomActivate, disabledQueryElements, }: Readonly<GenericGroupsProps>): import("react/jsx-runtime").JSX.Element;
