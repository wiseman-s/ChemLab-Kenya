 ...
 ***************************************************************************/
declare const AttachPointsContainer: import("react-redux").ConnectedComponent<(props: import("./Attach").AttachPointsProps & import("../../../modal.types").BaseCallProps) => import("react/jsx-runtime").JSX.Element, {
    className: string;
    primary: boolean;
    secondary: boolean;
    onCancel: () => void;
