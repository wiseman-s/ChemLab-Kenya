...
declare function GenSet({ labels, selected, onAtomSelect, onAtomActivate, className, group, disabledQueryElements, }: Readonly<GenSetProps>): import("react/jsx-runtime").JSX.Element;
export { GenSet };
