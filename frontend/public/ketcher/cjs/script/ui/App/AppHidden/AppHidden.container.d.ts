 ...
 ***************************************************************************/
import { type AppHiddenCallProps } from './AppHidden';
declare const AppHiddenContainer: import("react-redux").ConnectedComponent<(props: AppHiddenCallProps) => import("react/jsx-runtime").JSX.Element, {
