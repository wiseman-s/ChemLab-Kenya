 ...
 ***************************************************************************/
import { type AppCallProps } from './App';
declare const AppContainer: import("react-redux").ConnectedComponent<(props: AppCallProps) => import("react/jsx-runtime").JSX.Element, {
